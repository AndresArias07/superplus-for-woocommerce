...
class SP_WSV_Module_Checkout_Steps extends SP_WSV_Module {
    ...
    public function get_title() {
        return __( 'Finalizar compra', 'superplus-for-woocommerce' );
    }

    public function get_description() {
        return __( 'Mejora visual de la página de finalizar compra con resumen lateral y opciones de estilo.', 'superplus-for-woocommerce' );
    }

    public function get_image_url() {
        return SP_WSV_URL . 'includes/modules/checkout-steps/assets/img/finalizar-compra.webp';
    }
    ...
    public static function get_available_themes() {
        return array(
            'none'  => array(
                'title' => __( 'Sin tema', 'superplus-for-woocommerce' ),
            ),
            'light' => array(
                'title' => __( 'Claro', 'superplus-for-woocommerce' ),
            ),
            'dark'  => array(
                'title' => __( 'Oscuro', 'superplus-for-woocommerce' ),
            ),
        );
    }
    ...
    public function render_settings_tab() {
        ...
        echo '<h2>' . esc_html__( 'Finalizar compra', 'superplus-for-woocommerce' ) . '</h2>';
    ...
    protected function render_settings_form() {
            ...
            <table class="form-table" role="presentation">
                <tbody>
                    <tr>
                        <th scope="row">
                            <label>
                                <?php echo esc_html__( 'Distribución', 'superplus-for-woocommerce' ); ?>
                                <span class="spwsv-help dashicons dashicons-editor-help" title="<?php echo esc_attr__( 'Define el estilo visual y el “flujo” de la página de finalizar compra.', 'superplus-for-woocommerce' ); ?>"></span>
                            </label>
                        </th>
                        <td>
                            <div class="spwsv-choice-grid">
                                <?php foreach ( $distributions as $distribution_id => $distribution ) : ?>
                                    ...
                                    <label class="spwsv-choice">
                                        ...
                                        <span class="spwsv-choice-thumb spwsv-thumb--distribution-<?php echo esc_attr( $css_id ); ?>" aria-hidden="true"></span>
                    ...
                    <tr>
                        <th scope="row">
                            <label>
                                <?php echo esc_html__( 'Tema', 'superplus-for-woocommerce' ); ?>
                                <span class="spwsv-help dashicons dashicons-editor-help" title="<?php echo esc_attr__( 'Cambia solo colores/contraste del diseño. “Sin tema” usa el estilo del tema activo.', 'superplus-for-woocommerce' ); ?>"></span>
                            </label>
                        </th>
                        <td>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="spwsv_custom_css">
                                <?php echo esc_html__( 'CSS adicional', 'superplus-for-woocommerce' ); ?>
                                <span class="spwsv-help dashicons dashicons-editor-help" title="<?php echo esc_attr__( 'CSS opcional para ajustes finos. Se aplica al final del CSS del módulo.', 'superplus-for-woocommerce' ); ?>"></span>
                            </label>
                        </th>
                        <td>
                            <textarea id="spwsv_custom_css" class="large-text code" rows="14" name="<?php echo esc_attr( $this->option_key ); ?>[custom_css]"><?php echo esc_textarea( $opts['custom_css'] ); ?></textarea>
                            <p class="description"><?php echo esc_html__( 'Se inyecta al final del CSS del módulo. Úsalo para ajustes finos sin tocar el plugin.', 'superplus-for-woocommerce' ); ?></p>
                        </td>
                    </tr>
        ...
        <p>
            <?php echo esc_html__( 'Tip: para previsualizar, abre carrito y checkout en otra pestaña y refresca tras guardar.', 'superplus-for-woocommerce' ); ?>
        </p>
        <?php
    }
    ...
    public function enqueue_assets() {
        ...
        if ( $is_cart && $distribution !== '' ) {
            wp_enqueue_script(
                ...
                SP_WSV_PATH . 'includes/modules/checkout-steps/assets/js/cart-notices-relocate.js',
                array( 'jquery' ),
                SP_WSV_VERSION,
                true
            );
